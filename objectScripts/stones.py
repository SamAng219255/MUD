...
def main(args,player,layer):
 ...
 if action=="1":
  ...
  player["room"]=targets[stones.index(selected)]
  print("You approach the stone, upon seeing the glyph a word comes to mind. You are unable to describe how it would be pronounced, yet you instinctively speak it.\nIn an instant, the beam from the central pillar swings around and centers on the stone disk; it continues on into the distance, now stained with the stone's color, and you are drawn up into it in a whirl of the same color.\n\nYou awaken before smaller stone with the same glyph.")
